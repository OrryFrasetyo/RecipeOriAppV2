package com.orryfrasetyo.recipeoriapp.core.data.source.remote

import android.util.Log
import com.orryfrasetyo.recipeoriapp.core.data.source.remote.network.ApiResponse
import com.orryfrasetyo.recipeoriapp.core.data.source.remote.network.ApiService
...
class RemoteDataSource @Inject constructor(private val apiService: ApiService){
    ...
    suspend fun getDetailRecipe(id: Int): Flow<ApiResponse<RecipeResponse>> {
        return flow {
            try {
